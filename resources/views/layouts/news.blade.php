            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="hidden md:flex items-center space-x-2 border-l border-gray-200 dark:border-gray-800 pl-3.5 mr-1 shrink-0">
                    <a href="{{ \App\Models\Setting::get('app_play_store_url', 'https://play.google.com/store') }}" target="_blank" class="flex items-center justify-center w-7 h-7 rounded-full bg-gray-50 hover:bg-gray-150 dark:bg-gray-850 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 transition" title="Get Android App on Google Play">
                        <svg class="h-3.5 w-3.5 fill-current text-green-600 dark:text-green-455" viewBox="0 0 24 24">
                    ...
                    <a href="{{ \App\Models\Setting::get('app_app_store_url', 'https://www.apple.com/app-store') }}" target="_blank" class="flex items-center justify-center w-7 h-7 rounded-full bg-gray-50 hover:bg-gray-150 dark:bg-gray-850 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 transition" title="Download iOS App on App Store">
                        <svg class="h-3.5 w-3.5 fill-current text-black dark:text-white" viewBox="0 0 24 24">
