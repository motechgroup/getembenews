        ...
        @if($hasSocial)
            <div class="mt-6 space-y-3">
                <div class="relative flex items-center justify-center my-4">
                    ...
                    <span class="bg-white dark:bg-gray-900 px-3 text-[10px] uppercase font-bold text-gray-400 shrink-0">Or sign in with</span>
                    <div class="border-t border-gray-200 dark:border-gray-800 w-full"></div>
                </div>

                <div class="space-y-2">
                    @if($googleEnabled)
                        <a href="{{ route('social.redirect', 'google') }}" class="w-full flex items-center justify-center px-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-750 text-gray-700 dark:text-gray-200 font-bold text-xs rounded-lg transition shadow-sm hover:shadow group">
                            <svg class="h-4 w-4 mr-2 group-hover:scale-105 transition-transform" viewBox="0 0 24 24">
